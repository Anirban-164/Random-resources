...
def make_signal(start_time, end_time, values):
    ...
    for i, val in enumerate(values):
        sig.set_value_at_time(start_time + i, val)
...
def max_absolute_difference(first_signal, second_signal):
    ...
    for n in range(start, end + 1):
        val1 = first_signal.get_value_at_time(n)
        val2 = second_signal.get_value_at_time(n)
